...
function payrollByBorough(){
  ...
  for(let i = 0; i < data.length; i++){
    let payroll = data[i];
    if(payroll.borough == "QUEENS"){
      q++;
    }else if(payroll.borough == "MANHATTAN"){
      m++;
    }else if(payroll.borough == "BROOKLYN"){
      bk++;
    }else if(payroll.borough == "BRONX"){
      bx++;
    }else if(payroll.borough == "RICHMOND"){
      r++;
    }
  }
